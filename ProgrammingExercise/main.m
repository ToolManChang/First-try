...
P_correct = load('exampleP.mat');
P_correct_1 = P_correct.P(:,:,1);
P_correct_2 = P_correct.P(:,:,2);
P_correct_3 = P_correct.P(:,:,3);
P_correct_4 = P_correct.P(:,:,4);
P_correct_5 = P_correct.P(:,:,5);
G_correct = load('exampleG.mat');
%% Options
% [M, N]
mapSize = [15, 20];
